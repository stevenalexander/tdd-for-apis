...
[![BuildStatus](https://travis-ci.org/stevenalexander/tdd-for-apis.svg?branch=master)](https://travis-ci.org/stevenalexander/tdd-for-apis?branch=master) [![Code Climate](https://codeclimate.com/github/stevenalexander/tdd-for-apis/badges/gpa.svg)](https://codeclimate.com/github/stevenalexander/tdd-for-apis) [![dependencies Status](https://david-dm.org/stevenalexander/tdd-for-apis/status.svg)](https://david-dm.org/stevenalexander/tdd-for-apis) [![devDependencies Status](https://david-dm.org/stevenalexander/tdd-for-apis/dev-status.svg)](https://david-dm.org/stevenalexander/tdd-for-apis?type=dev)
